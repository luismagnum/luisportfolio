...
export default function Contacto() {
  return (
    <section data-aos="fade-left" className="bg-black py-16 text-white text-center mx-6">
      ...
      <div className="flex flex-wrap justify-center gap-6">
        ...
        <a
          href= "https://drive.google.com/file/d/1TobaTg-qmmObyVenI0Sv8MHspBBYehP8/view?usp=sharing"
          target="_blank"
          rel="noopener noreferrer"
        ...
        <a
          href="https://drive.google.com/file/d/1OqnDjiX1UNTFwO1W4_d4w6pXjVvmhH6P/view?usp=sharing"
          target="_blank"
          rel="noopener noreferrer"
